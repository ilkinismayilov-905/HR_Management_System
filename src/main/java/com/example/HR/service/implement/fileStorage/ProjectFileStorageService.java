...
import com.example.HR.config.ProjectFileStorageProperties;
...
public class ProjectFileStorageService {
    ...
    private final ProjectFileStorageProperties imagesStorageProperties;
    ...
    public ProjectAttachment storeFile(MultipartFile file, Project project){
        validateFile(file);
