...
import com.example.HR.config.UserImagesStorageProperties;
...
import com.example.HR.repository.user.UserAttachmentRepository;
...
public class UserImagesService {
    ...
    private final UserImagesStorageProperties imagesStorageProperties;
    ...
    public UserAttachment storeFile(MultipartFile file, UserProfile userProfile){
        validateFile(file);
        ...
        try {
            ...
            UserAttachment attachment = UserAttachment.builder()
                    .fileName(fileName)
